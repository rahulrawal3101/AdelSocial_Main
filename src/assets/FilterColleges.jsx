  ...
  return (
      <>
        <Header isBgColor={true}/>
          <Box >
<AppBar sx={{mt:"66px",bgcolor:"blue"}}>
    <Toolbar>
                <Typography  id='upperBox' sx={{color:'white',fontSize:'20px' }}>12 Result for all</Typography>
    </Toolbar>
</AppBar>
<Toolbar/>
  </Box>
...
{/* third filter start  */}
        ...
        <Grid item container   xs={12} sm={12} md={12} lg={8} sx={{display:'flex', justifyContent:'space-around', alignItems:'flex-start' }}>

          {
            cardApi.map((ele)=>{
              return(
                 <Grid key={ele._id}  onClick={()=>navigate(`/college/${ele._id}`)} item id='rightBox' xs={12} sm={4.2}  md={4.2} lg={4.5} sx={{backgroundColor:'#feffed', boxShadow: '0px 0px 5px 0px rgba(181,132,16,1)', borderRadius:'7px', margin:'48px 0px 0px 0px' }}>
                  <Box  id='clgimg'>
            ...
            <Typography sx={{fontSize:'23px',m:'0px 0px 2px 10px'}}>{ele.shortDescription}</Typography>
             <Box sx={{padding:'1px 5px 1px 5px'}}>
              <Typography sx={{color:'#388e3c', border:'1px solid #388e3c', fontSize:'13px', padding:'1px 4px 1px 4px', }}>BBA (Bachelor of Business Administration)</Typography>
            </Box>
              <Box sx={{mt:'4px' , padding:'1px 5px 1px 5px'}}> 
              <Typography sx={{color:'#388e3c', border:'1px solid #388e3c', fontSize:'13px', padding:'1px 4px 1px 4px'}}>BCA (Bachelor of Computer Applications)</Typography>
            </Box>
               <Box sx={{mt:'4px', width:'70px', padding:'1px 5px 1px 5px'}}>
              <Typography sx={{color:'#388e3c', border:'1px solid #388e3c', fontSize:'13px', padding:'1px 4px 1px 4px'}}>B.Com</Typography>
            </Box>
