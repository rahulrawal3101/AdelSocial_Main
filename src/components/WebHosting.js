...
const WebHosting = () => {
    ...
    const plans = [{ logo: cust, title: "Connect with pre-qualified customers", renew_price: 159, new_price: !plansAmt ? 190 : 210, planName: 'Single Domain Hosting', planSubName: 'Low-cost affordable hosting to get you started.', old_price: !plansAmt ? 'Rs.299' : 'Rs.399', percent: !plansAmt ? '83%' : '40%', features: ['1 Website', '10GB + 20G SSD/NVMe Disk Storage', 'Unlimited Data Transfer', 'Unlimited Subdomain', 'Unlimited Databases', 'Unlimited Email Accounts', 'Lifetime FREE SSL', '1-Click WordPress Installer'] },
    { logo: money, title: "Save time and money", renew_price: 159, new_price: !plansAmt ? 848 : 999, planName: 'Multiple Domain Hosting', planSubName: 'Everything you need to create your website', old_price: !plansAmt ? 'Rs.999' : 'Rs.1299', percent: !plansAmt ? '63%' : '20%', features: ['10 Websites', '20GB+80GB SSD/NVMe Disk Storage', 'Unlimited Data Transfer', 'Unlimited Subdomain', 'Unlimited Databases', 'Unlimited Email Accounts', 'Lifetime FREE SSL', '1-Click WordPress Installer'] },
    { logo: prize, title: "Rely on an experienced and knowledgeable team", renew_price: 159, new_price: !plansAmt ? 634 : 799, planName: 'C-panel Hosting', planSubName: 'Level-up with more power and enhanced features', old_price: !plansAmt ? 'Rs.799' : 'Rs.999', percent: !plansAmt ? '73%' : '30%', features: ['5 Websites', '10 GB SSD Storage', 'Unlimited Data Transfer', 'Unlimited Subdomain', 'Unlimited Databases', 'Unlimited Email Accounts', 'Lifetime FREE SSL', '1-Click WordPress Installer'] }].map((plan, index) => {
        return <Grid item key={plan.planName} sx={{ mr: { lg: '40px', md: '40px', sm: '10px' }, mb: { xs: '20px' }, borderRadius: '20px', bgcolor: 'white', scale: index === 1 && { xs: '1', lg: '1.1', md: '1.1' }, boxShadow: index === 1 && '-1px 3px 14px 0px rgba(0, 0, 0, 0.75)', transition: 'all 0.70s ease', border: '1px solid lightgray', height: '78%', width: { lg: '24%', xs: '80%', md: '27%', sm: '30%' } }} >
    ...
    return (
        <>
            <Grid container sx={{ padding: '60px 20px', justifyContent: 'center' }}>
