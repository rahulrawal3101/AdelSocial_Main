...
const CustomModal = () => {
    ...
    return (
        ...
        <Modal
            ...
            <Container disableGutters sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: { xs: '600px', lg: '700px', md: '700px', sm: '700px' } }} >


                <Grid container className='modalPopper' sx={{ mt: '30px', position: 'relative', width: { lg: '70%', xs: '80%' }, height: '100%', justifyContent: 'center', borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px', alignItems: 'flex-end', overflowX: { xs: 'hidden' }, overflowY: { lg: 'hidden', md: 'scroll', xs: 'scroll' } }}>
                    <Grid item lg={5} xs={12} sx={{ height: { lg: '100%', xs: '50%', md: '50%' }, bgcolor: "blue", p: { lg: "30px 20px", xs: '80px 20px' }, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    ...
                    <Grid item lg={7} xs={12} sx={{ height: '100%', bgcolor: "#FF9900", p: { lg: "10px", md: '30px', xs: '12px' }, pt: { xs: '0px' }, display: "flex", flexDirection: "column", justifyContent: "center" }}>
                        ...
                        <Button variant='contained' fullWidth sx={{ mt: '10px', fontSize: { lg: "20px", textTransform: 'unset', width: { xs: '50%', lg: '100%' } } }}>Get The Free Service</Button>
                    </Grid>
