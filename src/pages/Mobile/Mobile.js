...
const MobileDevelopment = () => {
    return (
        <>
            <Header />
            <Grid container sx={{ backgroundPosition: 'center', bgcolor: '#595959 ', backgroundBlendMode: 'multiply', p: '150px', pl: '50px', backgroundImage: `url(${awspic})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <Grid item>
                    <Typography variant='h2' sx={{ color: 'white', fontWeight: 900 }}>App Development</Typography>
                </Grid>
            </Grid>
