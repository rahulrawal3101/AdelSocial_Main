...
import provideImg from '../../assets/providesImg.jpg'
...
const DotNet = () => {
    ...
    const Technologies1 = ["ASP.NET MVC", " .NET Core", " .NET Core Rest API", "C#", " .NET Framework 4.8", " .NET Framework 4.7", " .NET Framework 4.6", " .NET Framework 4.5", " .NET Framework 4.0", "  VB.NET", "  Microservices", "  VS Add-ins", "  Azure Development", "  WinForms", "  WPF", "  WCF Services", "  WCF Data Services", "  JSON", "  SOAP", "  REST API", "  Kendo UI", "  SQL Server 2019", "  2017", "2016", "2014", "2012"]

    const Technologies3 = ["Authorize.NET ", " Stripe", " PayPal", "CareConnect", "Adyen", "FirstData", "MiGS", "DocuSign ", " Chart (amChart", " Google", "D3.js ", "Echarts", "AWS &amp; Azure Services ", "Google Map Services", " Live Streaming Services "]
    ...
    return (
        <>
            ...
            <Container disableGutters maxWidth={'xl'}>
                <Grid container>
                    <Grid item xs={12} sx={{ backgroundImage: `url('https://www.interviewbit.com/blog/wp-content/uploads/2021/08/dot-net-developer.jpg')`, backgroundBlendMode: "multiply", backgroundRepeat: "no-repeat", backgroundSize: "cover", bgcolor: "rgba(0, 0, 0, 0.8)", p: "50px" }}>
                            ...
                            <Grid item xs={12} sm={12} md={10} lg={6} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                    <Box>
                                        ...
                                        <Typography sx={{ color: "white", mt: "20px", fontSize: { lg: "15px", xs: '12px', md: '18px' } }}>
                    ...
                    <Grid item xs={12} lg={5} sx={{ mb: "20px", mt: { xs: "70px", sm: "70px", md: "70px", lg: "35px" }, display: { xs: "block", sm: "block", md: "block", lg: "none" } }}>
                        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
                ...
                <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                    ...
                    <Grid className='dotnetPage' item xs={12} sx={{ pb: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        <Grid item xs={12} sx={{ mb: "20px", display: "flex", justifyContent: "center" }}>
                    ...
                    <Grid item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                            <Typography sx={{ fontSize: "35px", fontWeight: "900", color: MAIN_COLOR }} >
                                ...
                                <Box >
                                    {
                                        CheckBoxData.map((ele) => {
                                            return (
                                                <Typography sx={{ ml: { xs: "0px", sm: "0px", md: "20px", lg: "20px" }, display: "flex", alignItems: "center", mt: "13px", color: MAIN_COLOR, fontWeight: 900 }}>
                    ...
                    <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", display: "flex", justifyContent: "center", mt: '0px', pt: '30px' }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                            <Typography sx={{ fontSize: { lg: "40px", xs: '30px' }, fontWeight: "800", color: MAIN_COLOR }} >
                            ...
                            <Box>
                                <Typography sx={{ fontSize: "40px", fontWeight: "800", color: MAIN_COLOR, m: "30px 0px" }} >
                                ...
                                <Grid container spacing={2}>
                                    {
                                        Technologies1.map((ele) => {
                                            return (
                                                <Grid item xs={12} sm={12} md={6} lg={4} sx={{ borderRadius: '10px', boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', }}>
                                                    <Paper sx={{ display: 'flex', justifyContent: 'center', border: "2px solid #e0e0e0", height: "100px", borderRadius: "18px" }} elevation={7}>
                    ...
                    <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, }}>
                            <Box>
                                <Typography sx={{ fontSize: { lg: "40px", xs: '30px' }, m: '30px 0px', fontWeight: "900", color: MAIN_COLOR }} >
                                ...
                                <Grid container spacing={3}>
                                    {
                                        Technologies2.map((ele) => {
                                            return (
                                                <Grid item xs={12} sm={12} md={6} lg={6} sx={{ borderRadius: '10px', boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', }}>
                                                    <Paper sx={{ display: 'flex', justifyContent: 'center', border: "2px solid #e0e0e0", p: "10px", height: "100px", borderRadius: "18px" }} elevation={2}>
                                                        <Typography sx={{ display: "flex", alignItems: "center", fontSize: "20px", fontWeight: 900, color: MAIN_COLOR }}>
                                                            <CheckBoxIcon sx={{ mr: "8px", color: MAIN_COLOR, fontSize: "25px" }} />{ele}
                                                        </Typography>
                                                    </Paper>
                    ...
                    <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, }}>
                            <Box>
                                <Typography sx={{ fontSize: { lg: "40px", xs: '30px' }, m: '30px 0px', fontWeight: "800", color: MAIN_COLOR }} >
                            ...
                            <Grid container sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, }} spacing={2}>
                                {
                                    AllBuisness.map((ele) => {
                                        return (
                                            <Grid item xs={12} sm={12} md={6} lg={4} sx={{ boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', }} >
                                                <Box >
                                                    <Box sx={{ p: "20px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                                                        {ele.icon}
                                                        <Typography align='center' sx={{ fontSize: "30px", fontWeight: "800", color: MAIN_COLOR }}>{ele.name}</Typography>
                                                    </Box>
                                                </Box>
                                            </Grid>
                                        )
