    ...
    return (
        <>
            ...
            <Container disableGutters maxWidth={'xl'}>
                <Grid container>
                    <Grid item xs={12} sx={{ backgroundImage: `url(https://cdn.activestate.com/wp-content/uploads/2021/12/python-coding-mistakes.jpg)`, backgroundBlendMode: "multiply", backgroundRepeat: "no-repeat", backgroundSize: "cover", bgcolor: "rgba(0, 0, 0, 0.8)", p: "50px" }}>
                                ...
                                <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                    <Box>
                                        <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                            Hire Python <Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 20px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                        </Typography>
