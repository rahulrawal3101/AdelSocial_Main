...
import awspic from '../../assets/drupal.png'
    ...
    return (
        <>
            ...
            <Grid container sx={{ backgroundPosition: 'center', bgcolor: '#595959 ', backgroundBlendMode: 'multiply', p: '150px', backgroundImage: `url(${awspic})`, backgroundRepeat: 'no-repeat', backgroundSize: 'contain' }}>
                <Grid item>
                    <Typography variant='h1' sx={{ color: 'white', fontWeight: 900 }}>Drupal</Typography>
                </Grid>
            </Grid>
            ...
            <Grid container sx={{ justifyContent: 'center', m: '50px 50px', pr: '100px' }}>
                <Grid item sx={{ width: '50%' }}>
                    <Typography paragraph textAlign={'left'}>
                        <span style={{ fontSize: '40px', color: MAIN_COLOR }}>Cloud computing with Drupal</span> <br />Amazon Web Services (Drupal) is the world’s most comprehensive and broadly adopted cloud, offering over 200 fully featured services from data centers globally. Millions of customers—including the fastest-growing startups, largest enterprises, and leading government agencies—are using AWS to lower costs, become more agile, and innovate faster.
                    </Typography>
                </Grid>
                <Grid item sx={{ width: '50%' }}>
