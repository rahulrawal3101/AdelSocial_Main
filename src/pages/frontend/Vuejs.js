    ...
    return (
        <>
            ...
            <Container disableGutters maxWidth="xl">
                <Grid container sx={{ height: "400px", backgroundImage: `url(${vuejs})`, bgcolor: 'rgb(90,90,90)', backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundBlendMode: "multiply" }}>
                    ...
                    <Grid item xs={12} sm={10} md={8} lg={7} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <Box sx={{ width: "100%", lineHeight: "7", p: "10px" }}>
                            ...
                            <Typography sx={{ color: "white", fontSize: { lg: "16px", xs: '12px', md: '16px' } }}>
                                Our VueJs developers streamline your business with next-gen web app development services.
                                Take your business to new heights with our VueJS app development services.
                            </Typography>
                    ...
                    <Grid item xs={12} md={5} lg={5} sx={{ mt: "15px", display: "flex", justifyContent: "center" }}>
                        <Box sx={{ lineHeight: "2.5" }}>
                            ...
                            <Typography sx={{ mt: "10px", fontSize: "20px", color: "white", fontWeight: "500" }}>
                                Our tech-driven VueJS development team consist of :
                            </Typography>
                            <ul>
                                <li style={{ color: "white", fontSize: "17px" }}>Skilled professionals with extensive knowledge and cross-domain experience.</li>
                                <li style={{ color: "white", fontSize: "17px" }}>Successful track record with hundreds of VueJS applications.</li>
                    ...
                    <Grid xs={12} item sx={{ display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: "60%" }}>
                            ...
                            <Typography align='center' sx={{ fontSize: "20px", fontWeight: "400", fontFamily: "Tisa Sans Pro sans-serif !important" }}>
                                We are a leading VueJS development company in India that caters services for small to large business enterprises. What makes us stand apart is our competence, commitment, expertise, and experience.
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid xs={12} item sx={{ display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: { xs: "100%", sm: "100%", md: "70%", lg: "60%" } }}>
                            ...
                            <Typography align='center' sx={{ color: "white", fontSize: "20px", fontWeight: "400", fontFamily: "Tisa Sans Pro sans-serif !important" }}>
                                Explore the engagement models we offer to hire Vue JS developer for your project         </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12} md={5} lg={6} sx={{ mt: "15px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <Box sx={{ lineHeight: "2.5", height: "70%", pt: "20px" }}>
                            ...
                            <Typography sx={{ fontWeight: "400", fontSize: "18px", lineHeight: "25px", textAlign: "left", color: "#fff" }}>
                                As the name suggests, the hourly-basis or pay-as-you-go model offers VueJS development services on an hourly basis. Billing is done per hour but you have to pay on a monthly basis while you can communicate via phone, email or Skype.
                            </Typography>
                ...
                <Grid container>
                    <Grid xs={12} item sx={{ display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: "60%" }}>
                            ...
                            <Typography align='center' sx={{ fontSize: "20px", fontWeight: "400", fontFamily: "Tisa Sans Pro sans-serif !important" }}>
                                Hire Vue Native Developer And/Or VueJS Developer In A Few Simple Steps. Discover How Our Process Works.
                            </Typography>
                        </Box>
                    </Grid>
                    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", p: "15px" }}>
                    ...
                    <Grid xs={12} sm={12} md={11} lg={12} item >
                        <Box sx={{ width: { xs: "100%", sm: "100%", md: "80%", lg: "70%" } }}>
                            ...
                            <Typography sx={{ fontSize: "20px", fontWeight: "400", fontFamily: "Tisa Sans Pro sans-serif !important" }}>
                                AdelSocial is the best destination to avail Vue web development and mobile development services. Here are a few reasons why you should hire VueJS developers from us:
                            </Typography>
                        </Box>
                    </Grid>
                                    ...
                                    <Grid container xs={12} sm={12} md={6} lg={5} sx={{ mt: "25px" }}>
                                        ...
                                        <Grid item xs={10}>
                                            ...
                                            <Typography sx={{ fontSize: "14px", fontWeight: "400", fontFamily: "Tisa Sans Pro sans-serif !important" }}>
                                                Our VueJS team includes seasoned developers with extensive skills and rich experience in the entire JS frameworks.
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                )
                ...
                <Grid container sx={{ backgroundImage: `url(${vector})`, p: "20px" }}>
                    <Grid item xs={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <Typography align='center' sx={{ fontSize: "29px", fontWeight: "800", color: "white" }} >
                            Planning to hire VueJS developers for your upcoming web development project?
                        </Typography>
                    </Grid>
                    <Grid item xs={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <Button variant='contained' sx={{ mt: "10px", bgcolor: MAIN_COLOR, height: "50px", borderRadius: "25px", fontWeight: "800", p: '10px 30px' }}>
                    ...
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "67%", lg: "67%" } }}>
                        ...
                        <Box>
                            <Accordion elevation={0}>
                                ...
                                >
                                    <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                        How can I hire a VueJS developer?
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                            ...
                            <Accordion elevation={0}>
                                ...
                                >
                                    <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                        What if I’m not satisfied with your Vue solution?
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
